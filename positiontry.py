...
# Plotting the amplitude of the FFT result
plt.figure(figsize=(10, 6))
plt.plot(frequencies, np.abs(fft_distance), color='forestgreen')
plt.title('Fourier Transform of the Distance Vector', fontsize=20)
